...
# Curves
```{r}
metadata <- data.table::fread("/scratch/Users/jost9358/Aug_23_dual_seq/metadata.csv")
filepaths <- paste0("/scratch/Users/jost9358/Aug_23_dual_seq/seq.f0.0.r0.0.nonhost.nonpareil/", 
                    metadata$Sample, 
                    ".npo")
